...
This is an ansible task that creates and configures ubuntu ( or other ) cloud init image on proxmox. 
...
The meanings of the role variables are explained in roles/role_name/defaults/main.yml
